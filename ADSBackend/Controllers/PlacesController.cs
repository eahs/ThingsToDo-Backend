...
namespace ADSBackend.Controllers
{
    ...
    public class PlacesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaceId,PlaceTypeId,Location,Activity,Description,Address,Hours,Cost,Latitude,Longitude,URL,Image")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaceId,PlaceTypeId,Location,Activity,Description,Address,Hours,Cost,Latitude,Longitude,URL,Image")] Place place)
        {
            if (id != place.PlaceId)
            {
                return NotFound();

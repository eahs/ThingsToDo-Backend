...
namespace ADSBackend.Controllers
{
    ...
    public class PlacesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaceId,PlaceTypeId,Name,Location,Activity,Description,Address,Hours,Cost,Latitude,Longitude,Image")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaceId,PlaceTypeId,Name,Location,Activity,Description,Address,Hours,Cost,Latitude,Longitude,Image")] Place place)
        {
            if (id != place.PlaceId)
            {
                return NotFound();
